...
public class RentalController {
     ...
     */
    @Operation(summary = "Returns every rental listed on the platform.")
    @GetMapping
     ...
     */
    @Operation(summary = "Returns the detail of a single rental.")
    @GetMapping("/{id}")
     ...
     */
    @Operation(summary = "Creates a new rental owned by the authenticated user, storing the uploaded picture on disk.")
     ...
     */
    @Operation(summary = "Updates an existing rental. Only the owner of the rental may perform this action.")
